 ...
 * alternative is via the {@link com.jsmobile.route.view.SlidingTabLayout.TabColorizer} interface which provides you complete control over
...
public class SlidingTabLayout extends HorizontalScrollView {
     ...
     * {@link #setCustomTabColorizer(com.jsmobile.route.view.SlidingTabLayout.TabColorizer)}.
     */
    ...
    public interface SelectPageListener {
        ...
        void updateSubView(int position);
    }
    ...
    /**
     * Set the {@link android.support.v4.view.ViewPager.OnPageChangeListener}. When using {@link com.jsmobile.route.view.SlidingTabLayout} you are
    ...
    private class InternalViewPagerListener implements ViewPager.OnPageChangeListener {
        ...
        public void onPageSelected(int position) {
            ...
            mSelectPageListener.updateSubView(position);
            //Log.d("SlidingTabLayout", mViewPager.getAdapter().getPageTitle(position).toString());
        }
