...
public final class ImageCache {
     ...
     * to a {@link RetainFragment}
     *
     * @param fragment The calling {@link FragmentActivity}
     * @return An existing retained ImageCache object or a new one if one did
     *         not exist
     */
    public static final ImageCache findOrCreateCache(final Fragment fragment, Context appContext) {

        // Search for, or create an instance of the non-UI RetainFragment
        final RetainFragment retainFragment=findOrCreateRetainFragment(fragment.getFragmentManager());
